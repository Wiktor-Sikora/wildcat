...
function comment(pk, likesCount, dislikesCount, state) {
    return {
        state: state,
        ...
        makeRequest() {
            this.state ? method = 'like' : method = 'dislike'
            fetch(`/api/products/comments/${method}/${pk}`, {method: 'PUT', headers: {"X-CSRFToken": this.getCookie('csrftoken')}})
        },
        deleteComment() {
