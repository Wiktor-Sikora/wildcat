...
function comment(pk, like, dislike, likesCount, dislikesCount) {
    return {
        ...
        makeRequest(likeType) {
            fetch(`/api/products/comments/${likeType}/${pk}`, {method: 'PUT', headers: {"X-CSRFToken": this.getCookie('csrftoken')}})
        },
        deleteComment() {
            fetch(`/api/products/comments/delete/${pk}`, {method: 'DELETE', headers: {"X-CSRFToken": this.getCookie('csrftoken')}})
        },
        getCookie(name) {
